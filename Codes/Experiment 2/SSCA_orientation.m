...
function SSCA_orientation(date,subjectname,start,over)
...
%% 光栅相关参数 Grating parameter
 ...
 %% %%%%%%%%%%%%%%%%%%%按任意键开始实验%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   while KbCheck; end
   Screen('DrawText',window,'Orientation task',FixationRect(1)-160,FixationRect(2)-50,[0 0 0]);%提示开始  
                    ...
                    for pp=1:round(FramesofOneFlickerPeriod)
                        ...
                        elseif keycode(qkey)==1
                            if ~dummymode
                                ...
                                status = Eyelink('ReceiveFile',edfFile,[subjectid startnumber '_o_Eyelink.edf']);
                            end
                            sca;
                            return
                        end
...
%                 Beeper(1000,0.7,0.2);
        ...
        %% -------------------------------------------------
        save([subjectid '_o_paramatrix'],'paramatrix','attMatrix');  
